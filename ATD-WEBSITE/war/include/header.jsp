				...
				<%
					...
					if (request.getSession().getAttribute("username") == null) {
						...
						if (request.getSession().getAttribute("username") instanceof User) {
							out.print("<ul class='nav navbar-nav'>" + "<li><a href='/ATD-WEBSITE/werkplaats/werkplaats.jsp'>Werkplaats</a></li>"
									+ "<li><a href='/ATD-WEBSITE/voorraad/voorraad.jsp'>Voorraad</a></li>" + "</ul>");
