		...
		<div class="collapse navbar-collapse"
			...
			<%
				...
				if (request.getSession().getAttribute("username") == null) {
					...
					User gebruiker = (User)request.getSession().getAttribute("username");
					out.print("<ul class=\"nav navbar-nav navbar-right\"> <li><a href=\"/ATD-WEBSITE/Logout.do\">" + gebruiker.getNaam() + "</a></li> </ul>");
				}
			%>
		</div>
	</div>
