    ...
    <div class="container">
      ...
      <div class="master-login clearfix">
        ...
        <div class="input-group">
          <span class="input-group-addon" id="basic-addon1"> Gebruikersnaam </span>
        ...
        <div class="input-group">
          ...
          <input type="password" class="form-control" aria-describedby="basic-addon1"> </div>
        <button type="button" class="btn btn-success navbar-btn pull-right">aanmelden</button>
        <!--   error die alleen verschijnt als iets niet correct is ingevuld -->
        <!--  <div class="alert alert-danger" role="alert">
          <span class="sr-only">Error:</span> er is iets ongeldig </div> --></div>
      <!--    footer  -->
      <div class="footer">
        <p>Team 3</p>
      </div>
